...
main_tp = "/mnt/climstor2/vol01_ecmwf/download/patmosx/cld_opd_acha/raw"
drive_auth()
drive_user()
...
for(ix in 1998:2021){
  ...
  era5land_tp_pad <- drive_ls(path = paste("datasets/PATMOSX/new-cld_opd_acha/patmosx-cld_opd_acha", ix, sep = "-"),
