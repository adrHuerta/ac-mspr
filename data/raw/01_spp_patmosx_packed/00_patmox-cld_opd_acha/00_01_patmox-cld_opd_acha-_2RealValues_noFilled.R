# cld_opd_acha		-127*	127*	0.0322835	3.9	meters	0.65µm	 Cloud optical depth at 0.65µm, determined from ACHA
...
for(year_x in years_data){
  ...
  path_data <- paste("/mnt/climstor2/vol01_ecmwf/download/patmosx/cld_opd_acha/raw/", year_x, sep = "")
  ...
  main_tp = "/scratch2/ahuerta/patmosx/cld_opd_acha/raw_rv"
  ...
  lapply(seq_along(names(r_stack)),
         function(ijx){
           ...
           placeholder <- (placeholder * 0.0322835) + 3.9 # SCALING + Offset
