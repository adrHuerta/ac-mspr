...
main_tp = "/mnt/climstor2/vol01_ecmwf/download/patmosx/cloud_water_path/raw"
drive_auth()
drive_user()
...
for(ix in 1998:2021){
  ...
  era5land_tp_pad <- drive_ls(path = paste("datasets/PATMOSX/new-cloud_water_path/patmosx-cloud_water_path", ix, sep = "-"),
