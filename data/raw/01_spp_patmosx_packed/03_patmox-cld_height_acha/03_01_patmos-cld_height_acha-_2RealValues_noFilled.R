# cld_height_acha	km	-32767*	32767*	0.000305185	10	meters	None	Cloud height computed using ACHA
rm(list = ls())
...
for(year_x in years_data){
  ...
  path_data <- paste("/mnt/climstor2/vol01_ecmwf/download/patmosx/cld_height_acha/raw/", year_x, sep = "")
  ...
  main_tp = "/scratch2/ahuerta/patmosx/cld_height_acha/raw_rv"
  ...
  lapply(seq_along(names(r_stack)),
         function(ijx){
           ...
           placeholder <- (placeholder * 0.000305185) + 10 # SCALING + Offset
