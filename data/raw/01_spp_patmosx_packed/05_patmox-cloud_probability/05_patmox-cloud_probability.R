...
main_tp = "/mnt/climstor2/vol01_ecmwf/download/patmosx/cloud_probability/raw"
drive_auth()
drive_user()
...
for(ix in 2019:2023){
  ...
  era5land_tp_pad <- drive_ls(path = paste("datasets/PATMOSX/cloud_probability/patmosx-cloud_probability", ix, sep = "-"),
