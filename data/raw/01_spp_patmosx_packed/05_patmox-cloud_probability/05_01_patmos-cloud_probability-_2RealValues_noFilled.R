# cloud_probability		-127*	127*	0.00393701	0.5	meters	None	Probability of a pixel being cloudy from the Bayesian cloud mask
rm(list = ls())
...
for(year_x in years_data){
  ...
  path_data <- paste("/mnt/climstor2/vol01_ecmwf/download/patmosx/cloud_probability/raw/", year_x, sep = "")
  ...
  main_tp = "/scratch2/ahuerta/patmosx/cloud_probability/raw_rv"
