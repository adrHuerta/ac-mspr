...
main_tp = "/mnt/climstor2/vol01_ecmwf/download/patmosx/cloud_fraction/raw"
drive_auth()
drive_user()
...
for(ix in 2021:2021){
  ...
  era5land_tp_pad <- drive_ls(path = paste("datasets/PATMOSX/new-cloud_fraction/patmosx-cloud_fraction", ix, sep = "-"),
