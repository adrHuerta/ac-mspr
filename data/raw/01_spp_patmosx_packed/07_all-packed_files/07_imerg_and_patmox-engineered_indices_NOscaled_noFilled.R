...
main_gsmap_path_to_read <- "/mnt/climstor2/vol01_ecmwf/download/gpm_imerg"
main_path_to_save <- file.path("/mnt/climstor2/vol01_ecmwf/download/patmosx", "features_imerg")
...
for(year_x in 1998:2021){
  ...
  lapply(
    ...
    function(year_x_date_i){
      ...
      pr_sat_data <- file.path(main_gsmap_path_to_read, "raw3", year_x, year_x_date_i)
