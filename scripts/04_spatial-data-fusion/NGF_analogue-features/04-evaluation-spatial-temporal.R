...
# cv output files
obs_bc_f <- dir("output/04_spatial-data-fusion/cv_NGF_features/cv-obs_bc", full.names = TRUE, recursive = TRUE)
hmg_obs_bc_f <- dir("output/04_spatial-data-fusion/cv_NGF_features/cv-hmg_obs_bc", full.names = TRUE, recursive = TRUE)
qc_obs_f <- dir("output/04_spatial-data-fusion/cv_NGF_features/cv-qc_obs", full.names = TRUE, recursive = TRUE)
...
ggsave(
  "output/04_spatial-data-fusion/SPDF_metrics-NGF_features-04.pdf",
  plt4,
  units = "in",
  width = 4.5,
  height = 3.5,
