...
for(date_to_merge in cv_days$dates){
  ...
  get_analogues_dates <- readRDS(paste0("output/03_precipitation-pattern-analogue/cv/cv-qc_obs/",
                                         date_to_merge, ".RDS"))
  ...
  saveRDS(
    output_cv,
    file = file.path("output/04_spatial-data-fusion/cv_median/cv-qc_obs",
