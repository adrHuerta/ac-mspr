...
source("R/analogues/select_pareto_subset.R")
...
for (yy in years) {
  ...
  parallel::mclapply(
    ...
    function(ijx){
      ...
      year_folder  <- file.path("output", "06_prec4tsa/prec4tsa_hmg_obs_bc", format(ijx, "%Y"))
      ...
      final_analogues <- select_pareto_subset(final_analogues)$operational_subset
