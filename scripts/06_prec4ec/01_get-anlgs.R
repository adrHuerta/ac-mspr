...
for (yy in years) {
  ...
  parallel::mclapply(
    ...
    function(ijx){
      ...
      year_folder  <- file.path("output", "06_prec4ec_obs_bc", format(ijx, "%Y"))
      ...
      final_analogues <- final_analogues[order(final_analogues$mean_metric, decreasing = TRUE), ][1, ]
