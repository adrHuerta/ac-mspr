...
Huerta, A., Serrano-Notivoli, R., & Brönnimann, S. (2026). An analogue-conditioned multi-satellite framework for daily precipitation reconstruction (Submitted).

## Acknowledgements

This research has been made possible by support from the Swiss Government Excellence Scholarships for Foreign Scholars (ESKAS-Nr: 2023.0404).
